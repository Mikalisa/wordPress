...
(function() {
		...
		init : function(ed, url) {
			...
			ed.addCommand('htext', function() {
				...
				if (hText !== null) {
						...
						shortcode = '[blogrock_pullquote]' + hText + '[/blogrock_pullquote]';
			...
			ed.addCommand('s_map', function() {
					var shortcode = '[blogrock_map api_key="INSERT YOUR API KEY"  id="blogrock_map-1" coords="52.339381, 4.260405" zoom="5" type="satellite"]';
					ed.execCommand('mceInsertContent', 0, shortcode);
			...
			ed.addCommand('s_video', function() {
				var shortcode = '[blogrock_video from="-->You can choose: youtube, vimeo, dailymotion" id="Video ID eg. sdsd#545sd"]';
				ed.execCommand('mceInsertContent', 0, shortcode);
	...
	// Register plugin
	tinymce.PluginManager.add( 'blogrock-core', tinymce.plugins.smartlib );
})();