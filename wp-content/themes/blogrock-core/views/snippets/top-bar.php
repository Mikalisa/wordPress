            ...
            <div class="col-xs-7 col-md-9">
                    ...
                    if ( class_exists('SitePress') ) {
                        ...
                        <nav class="nav nav-pills nav-top smartlib-language-menu">
                            <p><span class="smartlib-label-inside-menu"><?php esc_html_e('Languages', 'blogrock-core') ?>: </span></p>
                    ...
                    <p class="smartlib-top-bar-info"><?php blogrock_get_section_info_text('header'); ?></p>

            </div>
            <div class="col-xs-5 col-md-3 hidden-xs">

<?php do_action('blogrock_social_links', 'top') ?>
            </div>
