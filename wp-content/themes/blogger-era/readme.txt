...
Blogger Era includes support for Infinite Scroll in Jetpack.

= Where can I find theme demo? =
You can check our Theme Demo at http://demo.96themes.com/blogger-era/

== Changelog ==
= 1.0.8 - Sep 7 2019 =
* Tested upto 5.2.2
* Fixed the issue of elmentor
...
= 1.0.4 - Nov 26 2018 =
* Added post-format, featured-images and featured-image-header tag
* Updated pot file.

= 1.0.3 - Nov 20 2018 =
* Minor changes in css
* Fix minor issue of search page

= 1.0.2 - Nov 08 2018 =
* Minor Changes in readme file.
* Changed fontawsome to 4.7.0 version
...
Blogger Era WordPress Theme, Copyright (C) 2018, 96 Themes
Blogger Era is distributed under the terms of the GNU GPL
...
Images
	* https://pixabay.com/en/coffee-cup-espresso-hands-food-2608864/
	* https://pixabay.com/en/writing-hand-coffee-notepad-3321866/
	* https://pixabay.com/en/portrait-woman-female-young-person-597173/
	
Other Images: 
	screenshot.png self created GPLv2
	sidebar-left.png self created GPLv2 
	sidebar-no.png self created GPLv2 
	sidebar-right.png self created GPLv2
	search.png  self created GPLv2 
	default.jpg: https://pixabay.com/en/coffee-tablet-headphones-work-1128140/	
	404.png https://pixabay.com/en/filler-pen-fountain-pen-office-148544/
